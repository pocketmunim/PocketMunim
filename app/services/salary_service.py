...
class SalaryService:
    ...
    async def seed_annual_salaries(
        ...
        # FIXED: Fetch Account Name & Balance BEFORE the loop to ensure clean ledger metadata
        ...
        for m in range(1, 13):
            ...
            if sal_res.data and is_past:
                ...
                # FIXED: Changed type to "CREDIT" and injected "account_name"
        ...
        # Update account balance to include all disbursed past salaries in a single bulk transaction
