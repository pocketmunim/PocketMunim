...
JSON OUTPUT SCHEMA:
{
  ...
  "query": { "is_query": "boolean", "query_type": "string or null", "target": "string or null" },
  "loan": { "intent": "string or null", "lender": "string or null", "amount": "float or null" },
  "salary": { "intent": "string or null", "month": "string or null", "amount": "float or null" },
  "account": { "intent": "string or null", "account_name": "string or null", "account_type": "string or null" },
  "delete": { "intent": "string or null", "selection_mode": "string or null", "target_date": "string or null" },
  "report": { "intent": "string or null", "format": "string or null", "period": "string or null" }
}
                        ...
                        if source_acc_obj:
                            ...
                            if current_bal < tot_amt:
                                response_sections.append(
                                    f"❌ *Insufficient Balance* in {source_acc_obj['account_name']}.")
                                continue
