-- ==============================================================================
-- POCKETMUNIM ATOMIC LOAN LEDGER RPCs (ACID COMPLIANT)
-- Eliminates TOCTOU Race Conditions for FIN-02
-- ==============================================================================

-- 1. Atomic Loan Registration & Disbursement
...
-- 2. Atomic EMI Payment Processing
...
-- 3. Atomic Batch Settle Past EMIs
...
-- 4. Atomic Flexible / Ad-Hoc Repayment
